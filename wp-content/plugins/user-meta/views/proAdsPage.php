    ...
    <div class="container-fluid">
        <div class="row">
            ...
            $more = "
				...
				<li>Display user's public profile.</li>
				<li>Display user listing.</li>
				<li>Get 10+ <a href='{$userMeta->website}/add-ons/'>add-ons</a>.</li>
                <div style='padding-left: 20px'>
                    <li>User Listing add-on</li>
                    <li>WooCommerce Integration add-on</li>
                    <li>MailChimp Integration add-on</li>
                    ...
                    <li>Author-Box add-on</li>
                    <li>Nextend Social Login Integration add-on</li>
                </div>
    <center>
